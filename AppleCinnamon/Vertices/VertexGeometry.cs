...
namespace AppleCinnamon.Vertices
{
    public struct VertexGeometry
    {
       ...
       {
            new InputElement(nameof(PositionX), 0, Format.R32_SInt, 0, 0),
            new InputElement(nameof(PositionZ), 0, Format.R32_SInt, 4, 0),
            new InputElement(nameof(IndexAndLight), 0, Format.R32_UInt, 8, 0),
            new InputElement(nameof(PositionYVisibilityAmbient), 0, Format.R32_UInt, 12, 0),
            new InputElement(nameof(Ambient), 0, Format.R32_UInt, 16, 0),
        };


        public VertexGeometry(byte block, int i, byte j, int k, byte[] lights, byte[][] ambients, byte visibility)
        {
            PositionX = i;
            PositionZ = k;
