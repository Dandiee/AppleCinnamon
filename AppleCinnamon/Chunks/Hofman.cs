...
namespace AppleCinnamon.Chunks
{
    static class Hofman
    {
        private static float _sunDirection = 4.48f;
        ...
        public static Vector3 Position { get; set; } = Vector3.UnitZ.Rotate(Vector3.UnitX, _sunDirection);

        public static float SunIntensity { get; set; } = 1.0f;
        public static float Turbitity { get; set; } = 1.0f;
        public static Vector3 HGg { get; set; } = new(0.9f, 0.9f, 0.9f);
        ...
        private static void ComputeAttenuation(float thetaS)
        {
        ...
        public static void UpdateEffect(ChunkEffect<VertexSkyBox> skyEffect)
        {
            //SunDirection += 0.001f;
