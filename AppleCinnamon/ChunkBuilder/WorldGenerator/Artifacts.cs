...
public static class Artifacts
{
    ...
    public static readonly Action<Random, Chunk, int, Int3>[] CanopyFunctions =
    {
    ...
    public static readonly VoxelDefinition[] TreeTypes =
    {
    ...
    public static void CanopyPyramid(Random rnd, Chunk chunk, Int3 trunkTop)
    {
    ...
    public static void CanopySphere(Random rnd, Chunk chunk, Int3 trunkTop)
    {
    ...
    public static void CanopyBeveledRectangle(Random rnd, Chunk chunk, Int3 trunkTop)
    {
        var radius = 2;
