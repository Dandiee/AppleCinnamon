namespace AppleCinnamon.ChunkBuilder.WorldGenerator
{
    ...
    //     {
    //         _daniNoise = new DaniNoise(WorldGeneratorOptions.HighMapNoiseOptions);
    //     }
    //     
    //     public Chunk GenerateVoxels(Int2 chunkIndex)
    //     {
    //         var chunkSizeXz = new Int2(WorldGeneratorOptions.ChunkSize, WorldGeneratorOptions.ChunkSize);
    //         var heatMap = new int[WorldGeneratorOptions.ChunkSize, WorldGeneratorOptions.ChunkSize];
    //         var maxHeight = WorldGeneratorOptions.WaterLevel + 1;
    //         for (var i = 0; i < WorldGeneratorOptions.ChunkSize; i++)
    //         {
    //             for (var k = 0; k < WorldGeneratorOptions.ChunkSize; k++)
    //             {
    ...
    //         var voxels = new Voxel[WorldGeneratorOptions.ChunkSize * initialSlicesCount * Chunk.SliceHeight * WorldGeneratorOptions.ChunkSize];
    ...
    // 
    //                 // voxels[i + WorldGeneratorOptions.ChunkSize * (height + Chunk.Height * k)] = new Voxel(4, 0);
    //             }
    //         }
    // 
    //         return chunk;
    ...
    //     {
    //         var maxHeight = 128;
    //         var chunk = new Chunk(chunkIndex, new Voxel[WorldGeneratorOptions.ChunkSize * WorldGeneratorOptions.ChunkSize * maxHeight]);
    // 
    // 
    //         for (var i = 0; i < WorldGeneratorOptions.ChunkSize; i++)
    //         {
    ...
    //                 {
    // 
    //                     var pixel = Noise.CalcPixel3D(i + (chunk.ChunkIndex.X * WorldGeneratorOptions.ChunkSize), j, k + chunk.ChunkIndex.Y * WorldGeneratorOptions.ChunkSize, .015f);
    ...
    //     {
    //         var maxHeight = 128;
    //         var voxels = new Voxel[WorldGeneratorOptions.ChunkSize * WorldGeneratorOptions.ChunkSize * maxHeight];
    // 
    //         var chunk = new Chunk(chunkIndex, voxels);
    // 
    // 
